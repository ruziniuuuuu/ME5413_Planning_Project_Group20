...
#include "me5413_world/path_tracker_pid_stanley_original_node.hpp"
...
geometry_msgs::Twist PathTrackerNode::computeControlOutputs(const nav_msgs::Odometry& odom_robot, const geometry_msgs::Pose& pose_goal)
{
  ...
  std::cout << "lateral error is " << lat_error << " heading error is " << heading_error << " steering is " << cmd_vel.angular.z << std::endl;
