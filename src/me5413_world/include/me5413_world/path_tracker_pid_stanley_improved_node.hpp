...
#ifndef PATH_TRACKER_PID_STANLEY_NODE_H_
#define PATH_TRACKER_PID_STANLEY_NODE_H_
...
#include <me5413_world/path_tracker_pid_stanleyConfig.h>
...
namespace me5413_world
{
    ...
    private:
        static const double TURNING_SPEED;
        static const double STANLEY_GAIN_TURNING;
        static const double HEADING_ERROR_THRESHOLD;
        static const double CROSS_TRACK_ERROR_THRESHOLD;
        ...
        double computeStanleyControl(const double heading_error, const double cross_track_error, const double velocity,double stanley_gain);

        void adjustStanleyKBasedOnVelocity(double velocity);
        ...
        dynamic_reconfigure::Server<me5413_world::path_tracker_pid_stanleyConfig> server;
        dynamic_reconfigure::Server<me5413_world::path_tracker_pid_stanleyConfig>::CallbackType f;
...
#endif // PATH_TRACKER_PID_STANLEY_NODE_H_